...
PROJECT_NAME_1 = "ScanQA_v1.0"
# PROJECT_NAME_R = "ScanQA_Refined_v3.0"
...
class ScanQADataset(Dataset, LoadScannetMixin, DataAugmentationMixin):
    def __init__(self, split='train', max_obj_len=60, num_points=1024, pc_type='gt', sem_type='607', filter_lang=False, use_unanswer=True, drop_sample=0.0):
        ...
        # build answer
        train_data = json.load(open(os.path.join(SCAN_FAMILY_BASE, f'annotations/qa/{PROJECT_NAME_1}_' + 'train' + ".json")))
        ...
        # load file
        anno_file = os.path.join(SCAN_FAMILY_BASE, f'annotations/qa/{PROJECT_NAME_1}_' + split + ".json")
